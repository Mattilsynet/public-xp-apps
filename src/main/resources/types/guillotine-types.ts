...
export type GuillotineResolvers = Record<string, (env: GraphQLResolverEnvironment) => any>
export type GuillotineEnumTypes = Record<string, GraphQLCustomEnumType>
type GuillotineCreationCallbacks = Record<string, (params: CreationCallbackParams) => void>
...
export type CreationCallbackParams = {
	addFields: (fields: Record<string, TypeAndArgs>) => void
	removeFields: (fields: Array<string>) => void
	modifyFields: (fields: Record<string, TypeAndArgs>) => void
	setInterfaces: (interfaces: Array<GraphQLType>) => void
